...
/** @author Joel */
public class AfficherPageModificationCompteAction
  ...
  public String execute() {
    ...
    // Autrement, seuls les administrateurs et les modérateurs peuvent accéder à la page de
    // configuration d'autrui
    if (session.getAttribute("connecte") != null
      ...
      if ((!request.getParameter("id").equals(session.getAttribute("connecte") + "")
        ...
        try {
          ...
          if (dao.read(idCompte) != null) request.setAttribute("vue", "pageModificationCompte.jsp");
          else {
          ...
          if ((request.getParameter("id").equals(session.getAttribute("connecte") + "")))
            request.setAttribute("vue", "pageMarcheASuivre.jsp");
          else request.setAttribute("vue", "pageGestionListeCompte.jsp");
          return "/index.jsp";
