 ...
 * @author Mikaël
 */
public class AfficherPageCreationLectureAction implements Action {
    @Override
    public String execute() {
        if(session.getAttribute("connecte") != null && session.getAttribute("role") != null
           && ((int)session.getAttribute("role")== Compte.CAPITAINE || (int)session.getAttribute("role")== Compte.PARTICIPANT))
