 ...
 * @author Mikaël
 */
public class AfficherPageListeLecturesAction implements Action  {
    @Override
...
/** @author Charles */
public class AfficherPageListeLecturesAction implements Action, RequestAware, SessionAware {
