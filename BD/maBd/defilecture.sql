...
--
-- Client :  localhost
-- Généré le :  Mer 07 Novembre 2018 à 01:09
...
INSERT INTO `compte` (`ID_COMPTE`, `ID_EQUIPE`, `COURRIEL`, `MOT_PASSE`, `NOM`, `PRENOM`, `POINT`, `MINUTES_RESTANTES`, `PROGRAMME_ETUDE`, `AVATAR`, `PSEUDONYME`, `ROLE`, `DEVENIR_CAPITAINE`) VALUES
(1, NULL, 'admin@mail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin', 'Admin', 0, 0, '', '/images/avatars/avatarCompte_defaut.png', 'admin', 4, 0),
(2, 1, 'gab@hotmail.com', 'gab', 'grenier', 'gab', 0, 0, 'francais', '/images/avatars/avatarCompte_defaut.png', 'gab', 1, 0),
(3, 1, 'slaver@hotmail.com', 'slaver', 'slaver', 'dure', 0, 0, 'prog', '/images/avatars/avatarCompte_defaut.png', 'slaverdure', 1, 0),
(4, 1, 'gab@gab.com', '41ae41107f68c5f6cb83171614f7cf276b0b3572', 'Grenier', 'Gabriel', 0, 0, 'Programmation', '/images/avatars/avatarCompte_defaut.png', 'GabrielGrenier', 1, 0);
...
--
ALTER TABLE `compte`
  MODIFY `ID_COMPTE` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `equipe`
  MODIFY `ID_EQUIPE` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
